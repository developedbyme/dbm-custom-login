<?php
	...
	// \DbmCustomLogin\OddCore\RestApi\BatchTrashPostsEndPoint
	class BatchTrashPostsEndPoint extends EndPoint {
		...
		public function perform_call($data) {
			...
			remove_action( 'transition_post_status',           array( '\DbmCustomLogin\Helper\Headlines', 'transition_post_status' ), 10, 3 );
			remove_action( 'transition_post_status',           array( '\DbmCustomLogin\Helper\PartnerPromotion', 'transition_post_status' ), 10, 3 );
