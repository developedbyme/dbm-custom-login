<?php
	namespace DbmCustomLogin\OddCore\Admin\MetaData;
	
	use \DbmCustomLogin\OddCore\Admin\MetaData\PostMetaDataBox;
	
	// \DbmCustomLogin\OddCore\Admin\MetaData\ReactPostMetaDataBox
	class ReactPostMetaDataBox extends PostMetaDataBox {
		...
		function __construct() {
			...
			//$portrait_image_meta_field = new \DbmCustomLogin\OddCore\Admin\MetaData\MetaField();
		...
		public function output_box_start($post) {
			?>
				<div id="recipe-metadata" class="postbox">
					<h3><span><?php _e($this->_display_name, DBM_CUSTOM_LOGIN_TEXTDOMAIN) ?></span></h3>
