<?php
	namespace DbmCustomLogin\OddCore\Admin\CustomPostTypes;
	
	// \DbmCustomLogin\OddCore\Admin\CustomPostTypes\CustomPostTypePost
	class CustomPostTypePost {
		...
		public function setup_labels_autonaming($name) {
			...
			$this->_labels = array(
				'name' => __( ucfirst($multiple_name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'singular_name' => __( ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'menu_name' => __( ucfirst($multiple_name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'name_admin_bar' => __( ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'add_new' => __( 'Add New', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'add_new_item' => __( 'Add New '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'edit_item' => __( 'Edit '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'new_item' => __( 'New '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'all_items' => __( 'All '.ucfirst($multiple_name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'view_item' => __( 'View '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'search_items' => __( 'Search '.ucfirst($multiple_name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'not_found' => __( 'No '.$multiple_name.' found', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'not_found_in_trash' => __( 'No '.$multiple_name.' found in trash', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'parent_item_colon'     => __( 'Parent '.ucfirst($name).':', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'archives'              => __( ucfirst($name).' Archives', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'edit_item'             => __( 'Edit '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'update_item'           => __( 'Update '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'view_item'             => __( 'View '.ucfirst($name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'search_items'          => __( 'Search '.ucfirst($multiple_name), DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'items_list'            => __( ucfirst($multiple_name).' list', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'items_list_navigation' => __( ucfirst($multiple_name).' list navigation', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'filter_items_list'     => __( 'Filter '.ucfirst($multiple_name).' list', DBM_CUSTOM_LOGIN_TEXTDOMAIN )
			);
			
			//'featured_image'        => __( 'Featured Image', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
			//'set_featured_image'    => __( 'Set featured image', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
			//'remove_featured_image' => __( 'Remove featured image', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
			//'use_featured_image'    => __( 'Use as featured image', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
			//'insert_into_item'      => __( 'Insert into item', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
			//'uploaded_to_this_item' => __( 'Uploaded to this item', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
		}
		...
		public function create_taxonomy($system_name, $display_name, $hierarchical) {
			$new_taxonomy = new \DbmCustomLogin\OddCore\Admin\Taxonomies\CustomTaxonomy();
