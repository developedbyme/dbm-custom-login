<?php
	namespace DbmCustomLogin\OddCore\Admin\Taxonomies;
	
	// \DbmCustomLogin\OddCore\Admin\Taxonomies\CustomTaxonomy
	class CustomTaxonomy {
		...
		public function setup_labels_autonaming($name) {
			...
			$this->_labels = array(
				...
				'not_found' => __( 'No '.$name.' found', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'not_found_in_trash' => __( 'No '.$name.' found in trash', DBM_CUSTOM_LOGIN_TEXTDOMAIN ),
				'parent_item_colon' => '',
