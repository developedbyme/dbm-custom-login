<?php
	namespace DbmCustomLogin\OddCore\Admin\Lists;
	
	// \DbmCustomLogin\OddCore\Admin\Lists\EditList
	class EditList {
		...
		function __construct() {
			...
			$this->_columns["master-ingredient"] = new \DbmCustomLogin\OddCore\Admin\Lists\EditListColumn();
		}
