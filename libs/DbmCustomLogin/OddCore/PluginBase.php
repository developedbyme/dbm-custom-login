<?php
	namespace DbmCustomLogin\OddCore;
	
	// \DbmCustomLogin\OddCore\PluginBase
	class PluginBase {
		...
		function __construct() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::__construct<br />");
			
			$this->register_hooks();
		}
		
		protected function register_lists() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_lists<br />");
		...
		protected function register_pages() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_pages<br />");
		...
		protected function add_additional_hook($additional_hook) {
			//echo("\DbmCustomLogin\OddCore\PluginBase::add_additional_hook<br />");
			
			$this->_additional_hooks[] = $additional_hook;
		}
		
		protected function create_additional_hooks() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::create_additional_hooks<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_additional_hooks() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_additional_hooks<br />");
		...
		protected function get_additional_hooks() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_additional_hooks<br />");
		...
		protected function add_custom_post_type($custom_post_type) {
			//echo("\DbmCustomLogin\OddCore\PluginBase::add_custom_post_type<br />");
			
			$this->_custom_post_types[$custom_post_type->get_system_name()] = $custom_post_type;
		}
		
		protected function create_custom_post_types() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::create_custom_post_types<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_custom_post_types() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_custom_post_types<br />");
		...
		protected function add_filter($filter) {
			//echo("\DbmCustomLogin\OddCore\PluginBase::add_filter<br />");
			
			$this->_filters[] = $filter;
		}
		
		protected function create_filters() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::create_filters<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_filters() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_filters<br />");
		...
		protected function get_pages() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_pages<br />");
		...
		protected function get_custom_post_types() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::custom_post_types<br />");
		...
		protected function get_filters() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_filters<br />");
		...
		protected function register_ajax_api_end_points() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_ajax_api_end_points<br />");
		...
		protected function get_ajax_api_end_points() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_ajax_api_end_points<br />");
		...
		protected function create_rest_api_end_points() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::create_rest_api_end_points<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_rest_api_end_points() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_rest_api_end_points<br />");
		...
		protected function get_rest_api_end_points() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_rest_api_end_points<br />");
		...
		protected function add_shortcode($shortcode) {
			//echo("\DbmCustomLogin\OddCore\PluginBase::add_shortcode<br />");
		...
		protected function register_shortcodes() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_shortcodes<br />");
		...
		protected function get_shortcodes() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_shortcodes<br />");
		...
		protected function add_meta_box($system_name, $box, $post_type = 'post', $context = 'advanced', $priority = 'default') {
			$new_registration = new \DbmCustomLogin\OddCore\Admin\MetaData\PostMetaDataBoxRegistration();
		...
		protected function create_meta_boxes() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::create_meta_boxes<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_meta_boxes() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_meta_boxes<br />");
		...
		protected function get_meta_boxes() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::get_meta_boxes<br />");
		...
		public function register_hooks() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::register_hooks<br />");
		...
		public function hook_admin_menu() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_admin_menu<br />");
		...
		public function hook_admin_enqueue_scripts() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_admin_enqueue_scripts<br />");
		...
		public function hook_rest_api_init() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_rest_api_init<br />");
		...
		public function hook_edit_form_after_title() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_edit_form_after_title<br />");
		...
		public function hook_edit_form_after_editor() {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_edit_form_after_editor<br />");
		...
		public function hook_save_post($post_id, $post, $update) {
			//echo("\DbmCustomLogin\OddCore\PluginBase::hook_save_post<br />");
		...
		public function hook_wp_enqueue_scripts() {
			foreach($this->javascript_files as $id => $path) {
				wp_enqueue_script($id, $path, array(), "wp-".get_bloginfo('version').','.DBM_CUSTOM_LOGIN_DOMAIN.'-'.DBM_CUSTOM_LOGIN_VERSION);
			}
		}
		...
		public static function test_import() {
			echo("Imported \DbmCustomLogin\OddCore\PluginBase<br />");
		}
	}
?>